...
public class Expression {
   ...
   public boolean equals(Object obj) {
      ...
      if (this.fldname != null && this.val != null) {
         return this.fldname.equals(other.fldname) && this.val.equals(other.val);
      } else if (this.fldname != null) {
         return this.fldname.equals(other.fldname) && other.val == null;
      } else {
         return this.val.equals(other.val) && other.fldname == null;
      }
   }
